...
class Sql
{
	...
	$admin_hashed = password_hash('Grp4admingrp4', PASSWORD_DEFAULT);
        $q1 = "INSERT INTO users(username, password, email, bio, isadmin ) VALUES ('admin','$admin_hashed','admin@hotmail.com', 'admin er best', 1)";
